...
5. `_archive/tools/governance_gate.py` 必须阻断 repair artifact 中任何 `formal_candidate_allowed=true`、`formal_ranking_allowed=true` 或 `production_candidate_allowed=true`。
...
```bash
python _archive/tools/strategy_optimization_stage_audit.py --rejected-artifacts logs/openclaw/rejected_backtest_artifacts.jsonl --json
```
...
```bash
python _archive/tools/ensemble_alpha_predeclared_gate_walk_forward.py \
...
- `_archive/openclaw/services/ensemble_observation_gate_service.py`
- `_archive/tools/ensemble_observation_gate.py`
...
- `_archive/openclaw/services/ensemble_alpha_sleeve_service.py`
- `_archive/openclaw/services/tushare_pro_alpha_feature_service.py`
- `_archive/openclaw/services/ensemble_core_contract_service.py`
- `_archive/openclaw/research/all_strategy_evidence_run.py`
- `_archive/openclaw/services/unified_strategy_recommendation_service.py`
- `_archive/tools/all_strategy_evidence_run.py`

后续可新增：

- `_archive/openclaw/services/ensemble_shadow_portfolio_service.py`
- `_archive/openclaw/services/ensemble_execution_cost_service.py`
...
```bash
python _archive/tools/all_strategy_evidence_run.py \
...
```bash
python _archive/tools/strategy_optimization_stage_audit.py \
