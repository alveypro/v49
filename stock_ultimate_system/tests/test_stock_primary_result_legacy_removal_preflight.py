...
def test_stock_primary_result_legacy_removal_preflight_default_canonical_has_zero_problem_fallback(tmp_path, monkeypatch):
...
def test_stock_primary_result_legacy_removal_preflight_default_path_has_no_legacy_structure_dependency():
    samples = [
    ...
    for sample in samples:
        html_text = render_stock_primary_result(build_stock_primary_result_view_model(sample))
...
def test_stock_primary_result_legacy_removal_preflight_default_canonical_keeps_quality_and_layout():
